      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-4">
            <Card variant="default" className="relative h-[360px] overflow-hidden bg-ds-surface-dark text-white">
              ...
              {!isConnected && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                  ...
                  <p className="text-sm text-white/80">Conectando...</p>
                </div>
              )}
              <div className="absolute bottom-3 left-3 rounded-md bg-white/10 px-2 py-1 text-xs">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                variant="ghost"
                onClick={toggleMute}
                className={cn(isMuted && "border border-ds-primary")}
              >
              ...
              <Button
                ...
                className={cn(isCameraOff && "border border-ds-primary")}
              >
              ...
              <Button
                ...
                className={cn(isSharingScreen && "border border-ds-primary")}
              >
        ...
        {roomState === "ended" && (
          <Card variant="default" className="p-5">
            ...
            <div className="mt-4 flex gap-2">
              <Button onClick={() => navigate("/app/profissional/agenda")}>Voltar para agenda</Button>
            </div>
          </Card>
        )}
      </div>
