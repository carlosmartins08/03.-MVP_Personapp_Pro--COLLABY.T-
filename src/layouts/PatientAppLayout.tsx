...
import { BookOpen, CalendarCheck, Home, LogOut, MessageCircle, User } from "lucide-react"
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:left-0 lg:bg-white lg:border-r lg:border-neutral-100 lg:z-20">
          ...
          <div className="px-4 py-4 border-t border-neutral-100">
            <div className="space-y-2">
              <SOSButton variant="bar" contacts={[]} className="w-full" />
              <p className="text-xs text-neutral-300 font-manrope text-center">Suporte de crise</p>
            </div>
          </div>
        </aside>
